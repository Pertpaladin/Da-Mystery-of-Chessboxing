...
public class character : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.Log(GameManager.fighters[GameManager.team1fighterIndex].health);
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (rightHand.enabled)
        {
            if (this.tag == "Player")
            {
                if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 0)
                {
                    GameManager.fighters[GameManager.team2fighterIndex].health -= .2f / GameManager.fighters[GameManager.team2fighterIndex].defenseStat * GameManager.fighters[GameManager.team1fighterIndex].attackStat;
                }
                else if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 1)
                {
                    GameManager.fighters[GameManager.team2fighterIndex].health -= .2f / GameManager.fighters[GameManager.team2fighterIndex].defenseStat * GameManager.fighters[GameManager.team1fighterIndex].attackStat * .5f;
                }
                else if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 2)
                {
                    GameManager.fighters[GameManager.team2fighterIndex].health -= .2f / GameManager.fighters[GameManager.team2fighterIndex].defenseStat * GameManager.fighters[GameManager.team1fighterIndex].attackStat * 2;
                }
                else if (GameManager.fighters[GameManager.team1fighterIndex].type == 1 && GameManager.fighters[GameManager.team2fighterIndex].type == 0)
                {
                    GameManager.fighters[GameManager.team2fighterIndex].health -= .2f / GameManager.fighters[GameManager.team2fighterIndex].defenseStat * GameManager.fighters[GameManager.team1fighterIndex].attackStat * 2;
            ...
            else
            {
                if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 0)
                {
                    GameManager.fighters[GameManager.team1fighterIndex].health -= .2f / GameManager.fighters[GameManager.team1fighterIndex].defenseStat * GameManager.fighters[GameManager.team2fighterIndex].attackStat;
                }
                else if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 1)
                {
                    GameManager.fighters[GameManager.team1fighterIndex].health -= .2f / GameManager.fighters[GameManager.team1fighterIndex].defenseStat * GameManager.fighters[GameManager.team2fighterIndex].attackStat * .5f;
                }
                else if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 2)
                {
                    GameManager.fighters[GameManager.team1fighterIndex].health -= .2f / GameManager.fighters[GameManager.team1fighterIndex].defenseStat * GameManager.fighters[GameManager.team2fighterIndex].attackStat * 2;
                }
                else if (GameManager.fighters[GameManager.team1fighterIndex].type == 1 && GameManager.fighters[GameManager.team2fighterIndex].type == 0)
                {
                    GameManager.fighters[GameManager.team1fighterIndex].health -= .2f / GameManager.fighters[GameManager.team1fighterIndex].defenseStat * GameManager.fighters[GameManager.team2fighterIndex].attackStat * 2;
        ...
        if (rightLeg.enabled || rightLegUpper.enabled)
        {
            if (this.tag == "Player")
            {
                if (GameManager.fighters[GameManager.team1fighterIndex].type == 0 && GameManager.fighters[GameManager.team2fighterIndex].type == 0)
